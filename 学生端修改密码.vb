...
Public Class 学生端修改密码
    ...
    Private Sub 学生端修改密码_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If TextBox1.Text <> 登录页面.passstr Then
        ...
        Else
            If TextBox2.Text <> TextBox3.Text Then
                ...
                TextBox3.Text = ""
            Else
                sqlstr = "UPDATE student set spwd= '" & TextBox2.Text & "'where sno='" & 学生端个人信息.TextBox1.Text & "'"
                ModiP(sqlstr)
                con.Close()
                TextBox1.Text = ""
                TextBox2.Text = ""
